            ...
            lifecycleScope.launch(Dispatchers.IO){
                ...
                if (responseCode == HttpURLConnection.HTTP_OK){
                    ...
                    finish()
                        ...
                        val errorStream = request.errorStream?.bufferedReader()?.readText()
                        runOnUiThread {
                            println("Error dari server: $errorStream")
                            Toast.makeText(this@MainActivity, "Login Failed: $responseCode", Toast.LENGTH_SHORT).show()
                    }
                }
            }
        }
